...
module.exports = {
  ...
  generateQRcode: function(id, length = 10, callback=null) {
    return "QR-" + rand.generate(length)+"-"+id;
  },

  generateCoupon: function(id, length = 10, callback=null) {
    return "CP-" + rand.generate(length)+"-"+id;
  },
