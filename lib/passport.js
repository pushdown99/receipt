...
module.exports = {
  ...
  setup: function (app) {
    ...
    passport.use (new local (function (username, password, done) {
      ...
      console.log (result);
      //if(password === result[0].password) { console.log('login-success', username, password); return done (null, { 'username': username, }); }
      if(password === result[0].password) { console.log('login-success', username, password); return done (null, result[0]) }
