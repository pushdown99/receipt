...
INSERT INTO `admin_member` VALUES (6,'206-86-50193','xyz','이마트 전주점','강희석','도매','소매','마트','063-259-1234','1998-12-02 15:00:00','전라북도','전주시 완산구','전주시 완산구 당산로 111(서신동 767)','사용','관리자','2021-01-20 11:40:30','관리자','2021-01-20 11:30:28'),(7,'214-88-59748','xyz','왱이콩나물국밥','유대성','숙박 및 음식점업','한식 음식점업','음식점','063-287-6980','1986-12-31 15:00:00','전라북도','전주시 완산구','전라북도 전주시 완산구 경원동2가 동문길 88','사용','관리자','2021-01-20 11:40:30','관리자','2021-01-20 11:35:44'),(8,'402-81-18476','xyz','PNB 풍년제과 한옥마을점','강지웅','숙박 및 음식점업','한식 음식점업','제과','063-226-2737','1986-12-31 15:00:00','전라북도','전주시 완산구','전라북도 전주시 완산구 은행로 61','사용','관리자','2021-01-20 11:40:30','관리자','2021-01-20 11:36:46'),(9,'201-81-21515','xyz',' 스타벅스 전주한옥마을점','송 데이비드 호섭','숙박 및 음식점업','휴게음식점','카페','1522-3232','1986-12-31 15:00:00','전라북도','전주시 완산구','전라북도 전주시 완산구 전동 187-9','사용','관리자','2021-01-20 11:40:30','관리자','2021-01-20 11:38:36');
...
-- Dump completed on 2021-01-20 20:48:12
