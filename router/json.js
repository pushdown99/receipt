...
module.exports = function (app) {
  ...
  app.get('/json/admin/search/:name/:grade/:stat/:date1/:date2', function (req, res) {
    var name  = (req.params.name =="all")? '%%':req.params.name;
    var stat  = (req.params.stat=="all")? '%%':req.params.stat;
    var grade = (req.params.grade=="all")? '%%':req.params.grade;
    var date1 = req.params.date1;
    var date2 = req.params.date2;
  ...
  app.get('/json/group/search/:name/:date1/:date2', function (req, res) {
    var name  = (req.params.name =="all")? '%%':req.params.name;
    var date1 = req.params.date1;
    var date2 = req.params.date2;
